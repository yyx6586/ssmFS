...
public interface UserHomeworkService {
    UserHomework homeworkSchoolRelease(String account, String gradeclass_id, String title, String subject_name, String homework, String showBadge, String token) throws Exception;
    ...
    void updateHomeworkShowBadge(int id, String showBadge, String token) throws Exception;

    // 根据 id 获取作业信息
    UserHomework homeworkById(int id, String token) throws Exception;

    // 根据 id 修改作业信息
    void updateHomework(int id, String title, String homework, String showBadge, String token) throws Exception;
}
